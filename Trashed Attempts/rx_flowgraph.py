...
class RX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.soapy_hackrf_source_0 = soapy.source(dev, "fc32", 1, 'hackrf=1',
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'C:\\Users\\asmig\\OneDrive\\Documents\\GNURadio\\Data\\rxdata', False)
