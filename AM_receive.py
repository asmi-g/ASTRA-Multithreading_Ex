...
# Title: AM_receive_tutorial
# Author: Elbert Chen
# Copyright: 2025
# Description: AM_receive tutorial
...
class AM_receive(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "AM_receive_tutorial", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AM_receive_tutorial")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'C:\\Users\\asmig\\OneDrive\\Documents\\GNURadio\\Data\\rxdata-mod', False)
